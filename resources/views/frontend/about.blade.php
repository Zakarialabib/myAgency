<x-guest-layout>
    ...
    <header class="container-fluid header" style="background-color:{{ $base_color }};">
            ...
            <div>
                <div class="flex-grow px-24">
                    <div class="xl:text-6xl lg:text-5xl md:text-5xl sm:text-4xl lg-text">
                        ...
                        <span
                            class="other-color xl:text-7xl lg:text-5xl md:text-5xl sm:text-4xl lg-text">{{ $sectiontitle->subtitle }}</span>
                    </div>
            ...
            <div>
                <div class="flex-grow">
                    <div class="xl:text-5xl lg:text-xl md:text-lg sm:text-lg lg-text">
                        ...
                        <span
                            class="other-color xl:text-7xl lg:text-5xl md:text-5xl sm:text-4xl lg-text">{{ $sectiontitle_1->subtitle }}</span>
                    </div>
                    <div class="normal-text">
    ...
    <div class="container-fluid clients-section pt-28">
        <div class="flex flex-wrap">
            <div class="w-full xl:text-5xl lg:text-xl md:text-lg sm:text-lg lg-text">
