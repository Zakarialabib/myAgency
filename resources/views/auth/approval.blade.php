    ...
    <div class="bg-indigo-400 h-screen">
        <div class=" container mx-auto flex flex-col px-5 py-24 justify-center items-center">
            ...
            <div class="w-full md:w-2/3 flex flex-col mb-16 items-center mt-5 text-center">
                <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">{{ __('Waiting Approval') }}</h1>
                <p class="mb-8 leading-relaxed">
                    {{ __('Your account is not activated, please wait or come back later') }}
                </p>
                <p class="text-sm mt-2 text-white mb-8 w-full"><a class="py-3 px-5 border rounded-lg" href="{{ route('front.home')}} ">
                    {{ __('Back Home') }}</a></p>
                <div class="flex">
                    <button type="button" class=" inline-flex py-3 px-5 rounded-lg items-center focus:outline-none">
                        ...
                        <span class="ml-4 flex items-start flex-col leading-none">
                            <span class="text-xs mb-1">{{ __('Download on the') }}</span>
                            <span class="title-font font-medium">Google Play</span>
                        </span>
                    </button>
                    <button type="button" class=" inline-flex py-3 px-5 rounded-lg items-center ml-4 focus:outline-none">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-6 h-6"
                            viewBox="0 0 305 305">
                            <path
