            ...
            <form action="{{ route('admin.business_setup') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="w-full flex flex-wrap">
                    <div class="lg:w-1/2 sm:w-full px-2 @error('website_title') has-error @enderror">
                        ...
                        <input type="text" name="website_title"
                            ...
                            value="{{ $website_title->value ?? '' }}" placeholder="{{ __('Enter website title') }}">
                    ...
                    <div class="lg:w-1/2 sm:w-full mt-2 px-2 @error('phone_number') has-error @enderror">
                        ...
                        <input
                            class="p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-blue-500"
                            name="phone_number" type="text" name="phone_number" value="{{ $phone_number->value ?? '' }}"
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label class="input-label d-inline">{{ __('logo') }}</label><small style="color: red">*
                                ( {{ __('ratio') }} 3:1 )</small>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label class="input-label d-inline">{{ __('Fav Icon') }}</label><small style="color: red">* (
                                {{ __('ratio') }} 1:1 )</small>
                            <div class="custom-file mb-3">
                ...
                <div class="w-full flex flex-wrap">
                    ...
                    <div class="lg:w-1/2 sm:w-full px-2 @error('social_twitter') has-error @enderror">
                        ...
                        <input
                            class="p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-blue-500"
                            wire:model="social_twitter" type="text" value="{{ $social_twitter->value ?? '' }}"
                    ...
                    <div class="lg:w-1/2 sm:w-full px-2 @error('social_instagram') has-error @enderror">
                        ...
                        <input
                            class="p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-blue-500"
                            wire:model="social_instagram" type="text" value="{{ $social_instagram->value ?? '' }}"
                ...
                <div class="w-full">
                    ...
                    <div class="mb-4 px-2">
                        ...
                        <textarea class="p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-blue-500"
                            rows="4" id="body_tags" name="body_tags">{{ $body_tags->value ?? '' }}</textarea>
                        <small class="text-red-500">{{ __('Facebook, Google Analytics or other script.') }}</small>
                ...
                <div class="w-full">
                    ...
                    <div class="mb-4 px-2">
                        <x-label for="meta_description" :value="__('Seo Meta Description')" />
                        <input
                            class="p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-blue-500"
                            type="text" value="{{ $meta_description->value ?? '' }}" id="meta_description"
                            name="meta_description" />
                        <x-input-error for="meta_description" />
                    </div>
                </div>
                <div class="w-full">
                    <div class="mb-4 px-2 @error('announcement') has-error @enderror">
                        ...
                        <input
                            class="p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-blue-500"
                            type="text" value="{{ $announcement->value ?? '' }}" id="announcement" name="announcement" />
                    ...
                    <div class="mb-4 px-2 @error('cookie_alert_text') has-error @enderror">
                        ...
                        <input
                            class="p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-blue-500"
                            wire:model="cookie_alert_text" type="text" value="{{ $cookie_alert_text->value ?? '' }}"
