    ...
    <form class="py-10" enctype="multipart/form-data" wire:submit.prevent="submit">
        ...
        <div class="lg:w-1/2 sm:w-full">
            ...
            <select wire:model="sectiontitle.page"
                ...
                <option value="1">{{ __('About Page') }}</option>
                <option value="2">{{ __('Team Page') }}</option>
                <option value="3">{{ __('Blog Page') }}</option>
                <option value="4">{{ __('Service Page') }}</option>
                <option value="5">{{ __('Portfolio Page') }}</option>
            </select>
        ...
        <div class="w-full">
            <x-label for="video" :value="__('Title')" />
