<div>
    ...
    <section class="py-3 px-4">
        <div class="flex flex-wrap items-center justify-between">
            ...
            <div class="float-right">
                ...
                <x-button primary type="button" onclick="Livewire.dispatch('ِcreateModal')">
                    {{ __('Create Page') }}
                </x-button>
            </div>
        </div>
    ...
    <x-card>
            ...
            <x-table.tbody>
                @forelse($pages as $id=>$page)
                    <x-table.tr>
                        ...
                        <x-table.td>
                            <livewire:toggle-button :model="$page" field="status" key="{{ $page->id }}" lazy />
                        </x-table.td>
                        <x-table.td>
                            <x-dropdown
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-32 p-1">
                                ...
                                <x-slot name="content">
                                    <x-dropdown-link wire:click="$dispatch('editModal', { id: {{ $page->id }} })">
                                        <i class="fas fa-edit"></i>
                                        {{ __('Edit') }}
                                    </x-dropdown-link>
                                    <x-dropdown-link wire:click="$dispatch('deleteModal', {{ $page->id }})"><i
        ...
        <livewire:admin.page.edit lazy page="{{ $page }}" />

        <livewire:admin.page.create lazy />
