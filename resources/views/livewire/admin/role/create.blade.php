<div>
    ...
    <form wire:submit.prevent="submit" class="pt-3">
        ...
        <div class="mb-4 {{ $errors->has('role.title') ? 'is-invalid' : '' }}">
            ...
            <input class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="text" name="title" id="title" required wire:model.defer="role.title">
        ...
        <div class="mb-4 {{ $errors->has('permissions') ? 'is-invalid' : '' }}">
            ...
            <x-select-list class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required id="permissions" name="permissions" wire:model.lazy="permissions"
