<div>
    ...
    <form wire:submit.prevent="languageChange" class="w-full pt-2">
        ...
        <div class="w-full px-2 py-2">
            <button type="submit"
                ...
                <span wire:target="languageChange" wire:loading role="status" aria-hidden="true">
                    <x-loading />
                </span>
                {{ __('Change language') }}
            </button>
        ...
        <div>
            ...
            <div class="w-full">
                <div class="mb-4 px-2">
                    ...
                    <input
                        class="p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-blue-500"
                        wire:model="meta_keywords" type="text" value="{{ $setting->meta_keywords }}"
