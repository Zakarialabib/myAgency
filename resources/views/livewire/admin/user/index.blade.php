<div>
    <div class="flex flex-wrap justify-center">
        ...
        <div class="lg:w-1/2 md:w-1/2 sm:w-full my-2 my-md-0">
            <input type="text" wire:model.debounce.300ms="search" class="p-3 leading-5 bg-white dark:bg-dark-eval-2 text-zinc700 dark:text-zinc300 rounded border border-zinc300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-blue-500"
    ...
    <x-modal.confirmation wire:model.defer="showDeleteModal">
        ...
        <x-slot name="footer">
            <button type="button" class="btn border-zinc300 text-zinc700 dark:text-zinc300 active:bg-zinc50 dark:active:text-zinc800 hover:text-zinc500 dark:active:bg-dark-eval-1 active:text-zinc300 dark:hover:text-zinc700" wire:click="$set('showDeleteModal', false)">{{ __('Go back') }}</button>
