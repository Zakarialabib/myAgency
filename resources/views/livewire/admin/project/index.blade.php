    ...
    <x-table>
        ...
        <x-table.tbody>
            @forelse($projects as $project)
                <x-table.tr class="panel-group" id="accordion-{{ $project->id }}" role="tablist" aria-multiselectable="true">
                    ...
                    <x-table.td>
                        <div class="inline-flex">
                            ...
                            <button
                                ...
                                type="button" wire:click='clone({{ $project->id }})' wire:loading.attr="disabled">
                            ...
                            <div class="container">
                                ...
                                @else
                                    ...
                                    @foreach ($images as $image)
                                        <img class="w-52 rounded-full" src="{{ asset('uploads/' . $image) }}" alt="">
                                    @endforeach
                                @endif
                            </div>
                        </div>
