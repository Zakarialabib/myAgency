<div>
    <form wire:submit.prevent="submit" class="pt-3">
                ...
                <select class="form-control lang" name="language_id" id="blog_lan">
                    ...
                    @foreach ($langs as $lang)
                        <option value="{{ $lang->id }}"
                            {{ $portfolio->language_id == $lang->id ? 'selected' : '' }}>{{ $lang->name }}</option>
                    @endforeach
                </select>
            ...
            <div class="col-sm-10">
                @foreach ($sliders as $slider)
                    <div class="edit-slider">
                        <img class="mb-2 show-img img-demo"
                            src="{{ asset('assets/front/img/portfolio/' . $slider->image) }}" alt="">
                        <div class="icheck-danger d-inline mr-2">
                            <input type="checkbox" id="{{ $slider->id }}" name="sliders[]"
                                value="{{ $slider->id }}">
                ...
                <div class="custom-file h80 drop-img mt-3">
                    <label class="custom-file-label h80 " for="image">
                        <h5 class="text-center">{{ __('Drop Or Select multiple image at a time') }}</h5>
                    </label>
        ...
        <div class="form-group row">
            <label for="featured_image" class="col-sm-2 control-label">{{ __('Featured Image') }}<span
                    class="text-danger">*</span></label>

            <div class="col-sm-10">
                <img class="mb-3 mw-400 show-img img-demo"
                    src="{{ asset('assets/front/img/portfolio/' . $portfolio->featured_image) }}" alt="">
                ...
                <select class="form-control" name="service_id" id="service_id">
                    @foreach ($services as $service)
                        <option value="{{ $service->id }}"
                            {{ $service->id == $portfolio->service_id ? 'selected' : '' }}>{{ $service->title }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="form-group row">
            ...
            <div class="input-group col-sm-10">
                ...
                <input type="text" class="form-control" name="start_date" id="start_date"
                    placeholder="{{ __('Start Date') }}" value="{{ $portfolio->start_date }}">
        ...
        <div class="form-group row">
            ...
            <div class="input-group col-sm-10">
                ...
                <input type="text" class="form-control" name="submission_date" id="submission_date"
                    placeholder="{{ __('Submission Date') }}" value="{{ $portfolio->submission_date }}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="link" placeholder="Live Link"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <select class="form-control" name="status">
                    ...
                    <option value="0" {{ $portfolio->status == 0 ? 'selected' : '' }}>{{ __('In Progress') }}
                    </option>
                    <option value="1" {{ $portfolio->status == 1 ? 'selected' : '' }}>{{ __('Completed') }}
                    </option>
                </select>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <textarea name="content" class="form-control summernote" rows="4"
                    placeholder="{{ __('Description') }}">{{ $portfolio->content }}</textarea>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" data-role="tagsinput" name="meta_keywords"
                    placeholder="{{ __('Meta Keywords') }}" value="{{ $portfolio->meta_keywords }}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" name="meta_description" placeholder="{{ __('Meta Description') }}"
                    rows="4">{{ $portfolio->meta_description }}</textarea>
