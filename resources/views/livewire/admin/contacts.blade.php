    ...
    <div class="p-4">
       ...
       <form wire:submit.prevent="deleteSelected">
        <x-modal.confirmation wire:model.defer="showDeleteModal">
            ...
            <x-slot name="footer">
                <button class="btn border-zinc300 text-zinc700 dark:text-zinc300 active:bg-zinc50 dark:active:text-zinc800 hover:text-zinc500 dark:active:bg-dark-eval-1 active:text-zinc300 dark:hover:text-zinc700" wire:click="$set('showDeleteModal', false)">{{ __('Go back') }}</button>
