            ...
            <div class="grid gap-2 sm:grid-cols-1 xl:grid-cols-2">
                ...
                <p>
                    <input type="email" wire:model.lazy="email" id="email" name="email"
                        ...
                        autocomplete="email" class="@error('email') is-invalid @enderror w-full bg-zinc-100 bg-opacity-50 rounded border border-zinc-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 text-base outline-none text-zinc-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                ...
                <p>
                    ...
                    <input type="text" wire:model.lazy="phone_number" id="phone_number" name="phone_number"
                        ...
                        autocomplete="mobile" class="@error('phone_number') is-invalid @enderror w-full bg-zinc-100 bg-opacity-50 rounded border border-zinc-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 text-base outline-none text-zinc-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                ...
                <p>
                    ...
                    <select id="subject" wire:model="subject" name="subject"
                        class="@error('subject') is-invalid @enderror w-full bg-zinc-100 bg-opacity-50 rounded border border-zinc-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 text-base outline-none text-zinc-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
