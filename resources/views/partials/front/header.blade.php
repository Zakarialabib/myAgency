    ...
    <div class="flex flex-wrap">
        ...
        <div class="flex-grow text-right">
            <div class="right_header_languages">
                <div
                    class="translate languages text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
