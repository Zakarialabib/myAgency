...
<div x-data="{ isSidebar: false }" <header x-data="{ isSticky: true, scrollPosition: 0 }" x-init="window.addEventListener('scroll', () => {
    ...
    <div class="mx-auto py-4 px-6 flex justify-between items-center">
        ...
        <ul class="hidden md:flex justify-between gap-6 mx-auto font-semibold font-heading">
            <li>
        ...
        <button class="self-center mr-8 md:hidden py-4 text-green-500" type="button" @click="isSidebar = !isSidebar">
            <svg class="text-green-500" fill="currentColor" width="24" height="14" viewbox="0 0 24 14"
    ...
    <div class="fixed top-0 left-0 bottom-0 w-5/6 max-w-sm z-50 overflow-y-scroll" x-show="isSidebar"
        ...
        <nav class="relative flex flex-col py-6 px-6 w-full h-full bg-white border-r overflow-y-auto">
            ...
            <ul class="lg:text-2xl sm:text-xl space-y-4 font-bold font-heading">
                ...
                <li class="hover:text-green-500 focus:text-green-500 hover:underline">
                    <a href="{{ url('/') }}#partners" x-on:click="isSidebar = false">
                        {{ __('Partners') }}
                    </a>
                </li>
                <li class="hover:text-green-500 focus:text-green-500 hover:underline">
