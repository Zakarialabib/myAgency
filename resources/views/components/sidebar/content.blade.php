<x-perfect-scrollbar as="nav" aria-label="main" class="flex flex-col flex-1 gap-4 px-3 overflow-auto">
    ...
    <x-sidebar.link title="{{ __('Blog Categories') }}" href="{{ route('admin.blog-categories.index') }}"
        :isActive="request()->routeIs('admin.blog-categories.index')">
        <x-slot name="icon">
            <x-heroicon-o-users class="flex-shrink-0 w-6 h-6" aria-hidden="true" />
        </x-slot>
    </x-sidebar.link>
    ...
    <x-sidebar.link title="{{ __('Project') }}" href="{{ route('admin.projects.index') }}" :isActive="request()->routeIs('admin.projects.index')">
        <x-slot name="icon">
            <x-heroicon-o-users class="flex-shrink-0 w-6 h-6" aria-hidden="true" />
        </x-slot>
    </x-sidebar.link>
